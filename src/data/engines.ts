...
export const engines: Engine[] = [
  ...
  /* ── Tercera ampliación: motores de generaciones 2000-2010s ── */
  {
    id: "bmw-n47-2-0d", slug: "bmw-n47-2-0d", code: "N47D20",
    fuel: "diesel", displacementCc: 1995, cylinders: 4, powerKw: 130, powerHp: 177, torqueNm: 350,
    architecture: "4 cilindros en línea, turbo, common-rail, cadena de distribución trasera",
    summary: "El 2.0d de BMW anterior al B47 (Serie 3 E90, Serie 5 F10 de primeras series, X1 E84). Muy sobrio, pero con fama justificada de desgaste prematuro de la cadena de distribución en los primeros años de producción.",
    dataStatus: "demo",
  },
  {
    id: "vag-2-0-fsi", slug: "vag-2-0-fsi", code: "2.0 FSI (EA113/EA888 gen1)",
    fuel: "gasolina", displacementCc: 1984, cylinders: 4, powerKw: 110, powerHp: 150, torqueNm: 200,
    architecture: "4 cilindros en línea, atmosférico o turbo (2.0 TFSI), inyección directa, correa de distribución",
    summary: "El gasolina de acceso del Grupo VW en la década de 2000-2010 (Golf V/VI, Passat B6, León 1P, Octavia 1Z). Sencillo en la versión atmosférica; la turbo (2.0 TFSI) de esos años consume aceite y sufre estiramiento de cadena en algunas unidades.",
    dataStatus: "demo",
  },
  {
    id: "psa-1-6-vti", slug: "psa-1-6-vti", code: "1.6 16v VTi/THP",
    fuel: "gasolina", displacementCc: 1598, cylinders: 4, powerKw: 80, powerHp: 109, torqueNm: 160,
    architecture: "4 cilindros en línea, atmosférico (VTi) o turbo (THP), desarrollado con BMW-PSA",
    summary: "El gasolina 1.6 de PSA de la época 207/308/C4 (2006-2013), co-desarrollado con BMW (Peugeot 207/Mini). El atmosférico VTi es sencillo; el turbo THP tiene historial de estiramiento de cadena de distribución en algunas unidades.",
    dataStatus: "demo",
  },
  {
    id: "opel-1-6-16v", slug: "opel-1-6-16v", code: "1.6 / 1.8 Ecotec 16V",
    fuel: "gasolina", displacementCc: 1598, cylinders: 4, powerKw: 85, powerHp: 115, torqueNm: 155,
    architecture: "4 cilindros en línea, atmosférico, correa de distribución",
    summary: "El gasolina atmosférico de Opel de los años 2000 (Astra H/J, Corsa D). Sencillo y muy conocido en cualquier taller; correa de distribución con intervalo a respetar.",
    dataStatus: "demo",
  },
  {
    id: "ford-1-6-tivct", slug: "ford-1-6-tivct", code: "1.6 Ti-VCT",
    fuel: "gasolina", displacementCc: 1596, cylinders: 4, powerKw: 77, powerHp: 105, torqueNm: 150,
    architecture: "4 cilindros en línea, atmosférico, distribución variable Ti-VCT, correa de distribución",
    summary: "El gasolina atmosférico de Ford de la época Focus Mk2/Fiesta Mk7. Sencillo y fiable; correa de distribución con intervalo a respetar, sin más sorpresas reseñables.",
    dataStatus: "demo",
  },
  {
    id: "toyota-1-6-vvti", slug: "toyota-1-6-vvti", code: "1.6 Valvematic/VVT-i",
    fuel: "gasolina", displacementCc: 1598, cylinders: 4, powerKw: 97, powerHp: 132, torqueNm: 160,
    architecture: "4 cilindros en línea, atmosférico, distribución variable VVT-i, cadena de distribución",
    summary: "El gasolina atmosférico de Toyota de la época Auris/Avensis. Sin turbo ni correa bañada en aceite: mecánica muy fiable, aunque algo justa de fuerza para el tamaño del Avensis.",
    dataStatus: "demo",
  },
  {
    id: "toyota-2-0-d4d", slug: "toyota-2-0-d4d", code: "2.0/2.2 D-4D",
    fuel: "diesel", displacementCc: 1998, cylinders: 4, powerKw: 93, powerHp: 126, torqueNm: 310,
    architecture: "4 cilindros en línea, turbo, common-rail",
    summary: "El diésel de Auris y Avensis de esa época. Reputación de fiabilidad sólida; bomba de inyección y EGR son los puntos a vigilar con muchos kilómetros.",
    dataStatus: "demo",
  },
  {
    id: "honda-2-2-idtec", slug: "honda-2-2-idtec", code: "2.2 i-DTEC",
    fuel: "diesel", displacementCc: 2199, cylinders: 4, powerKw: 110, powerHp: 150, torqueNm: 350,
    architecture: "4 cilindros en línea, turbo, common-rail (motor propio de Honda)",
    summary: "El diésel grande propio de Honda para el CR-V de esa época. Buen empuje y consumo contenido en carretera; EGR y filtro de partículas piden uso de carretera.",
    dataStatus: "demo",
  },
  {
    id: "renault-1-6-16v", slug: "renault-1-6-16v", code: "1.6 16V (K4M)",
    fuel: "gasolina", displacementCc: 1598, cylinders: 4, powerKw: 82, powerHp: 112, torqueNm: 148,
    architecture: "4 cilindros en línea, atmosférico, correa de distribución",
    summary: "El gasolina atmosférico de Renault de los años 2000-2010 (Mégane II, Scénic II, Clío III). Muy extendido y sencillo de mantener; correa de distribución con intervalo a respetar.",
    dataStatus: "demo",
  },
  {
    id: "mercedes-om651", slug: "mercedes-om651", code: "OM651",
    fuel: "diesel", displacementCc: 2143, cylinders: 4, powerKw: 125, powerHp: 170, torqueNm: 400,
    architecture: "4 cilindros en línea, turbo, common-rail",
