...
export const generationEngines: GenerationEngine[] = [
  ...
  /* ══ Quinta ampliación ══ */
  ge("audi:a8:d5", "audi-3-0-tdi", "50 TDI quattro", 2017, { transmission: "automatico", drivetrain: "total", consumption: 6.4 }),
  ge("audi:a8:d5", "ea888-2-0-tsi", "55 TFSI quattro", 2017, { transmission: "automatico", drivetrain: "total", consumption: 8.4 }),
  ge("audi:q8:4m", "audi-3-0-tdi", "50 TDI quattro", 2018, { transmission: "automatico", drivetrain: "total", consumption: 7.0 }),
  ge("audi:q8:4m", "ea888-2-0-tsi", "55 TFSI quattro", 2018, { transmission: "automatico", drivetrain: "total", consumption: 9.4 }),
  ge("mercedes-benz:cls:c257", "om654", "CLS 300 d", 2018, { transmission: "automatico", drivetrain: "trasera", consumption: 5.1 }),
  ge("mercedes-benz:cls:c257", "mercedes-om656", "CLS 400 d", 2018, { transmission: "automatico", drivetrain: "trasera", consumption: 5.9 }),
  ge("mercedes-benz:gls:x167", "mercedes-om656", "GLS 400 d 4MATIC", 2019, { transmission: "automatico", drivetrain: "total", consumption: 8.5 }),
  ge("mercedes-benz:gls:x167", "m264", "GLS 450 4MATIC", 2019, { transmission: "automatico", drivetrain: "total", consumption: 10.6 }),
  ge("volkswagen:beetle:a5", "ea211-1-5-tsi", "1.2/1.4 TSI", 2011, { endYear: 2019, consumption: 5.9 }),
  ge("volkswagen:beetle:a5", "ea288-2-0-tdi", "1.6/2.0 TDI", 2011, { endYear: 2019, consumption: 4.7 }),
  ge("volkswagen:scirocco:iii", "ea888-2-0-tsi", "1.4/2.0 TSI / R", 2008, { endYear: 2017, consumption: 6.9 }),
  ge("volkswagen:scirocco:iii", "ea288-2-0-tdi", "2.0 TDI", 2008, { endYear: 2017, consumption: 4.9 }),
  ge("volkswagen:transporter:t6", "ea288-2-0-tdi", "2.0 TDI 90/199", 2015, { endYear: 2024, drivetrain: "trasera", consumption: 7.2 }),
  ge("cupra:tavascan:default", "vw-meb-awd", "VZ (tracción total)", 2024, { transmission: "automatico", drivetrain: "total", consumption: 17.0 }),
  ge("toyota:verso:ar20", "toyota-1-6-vvti", "1.6/1.8 Valvematic", 2009, { endYear: 2018, consumption: 7.0 }),
  ge("toyota:verso:ar20", "toyota-2-0-d4d", "1.6/2.0 D-4D", 2009, { endYear: 2018, consumption: 5.1 }),
  ge("toyota:hilux:an120", "toyota-1gd-diesel", "2.4/2.8 D-4D", 2015, { transmission: "automatico", drivetrain: "total", consumption: 7.9 }),
  ge("nissan:navara:np300", "toyota-1gd-diesel", "2.3 dCi biturbo 160/190", 2015, { transmission: "automatico", drivetrain: "total", consumption: 7.3 }),
  ge("peugeot:206:default", "psa-1-6-vti", "1.4/1.6 16V", 1998, { endYear: 2012, consumption: 6.3 }),
  ge("peugeot:206:default", "hdi-1-6", "1.4/2.0 HDi", 1999, { endYear: 2012, consumption: 4.2 }),
  ge("peugeot:307:default", "psa-1-6-vti", "1.4/1.6/2.0 16V", 2001, { endYear: 2008, consumption: 6.9 }),
  ge("peugeot:307:default", "hdi-1-6", "1.4/1.6/2.0 HDi", 2001, { endYear: 2008, consumption: 4.5 }),
  ge("peugeot:407:default", "hdi-2-0-dw10-older", "2.0/2.2 HDi", 2004, { endYear: 2011, consumption: 5.2 }),
  ge("peugeot:407:default", "psa-1-6-vti", "1.8/2.0 16V", 2004, { endYear: 2011, consumption: 7.4 }),
  ge("renault:laguna:iii", "renault-1-6-16v", "1.6/2.0 16V", 2007, { endYear: 2015, consumption: 7.0 }),
  ge("renault:laguna:iii", "dci-1-5-blue", "1.5/2.0 dCi", 2007, { endYear: 2015, consumption: 4.6 }),
  ge("renault:koleos:hy0", "tce-1-3", "1.3/1.6 TCe", 2017, { endYear: 2022, consumption: 6.8 }),
  ge("renault:koleos:hy0", "dci-1-5-blue", "1.7/2.0 dCi", 2017, { transmission: "automatico", endYear: 2022, drivetrain: "total", consumption: 5.4 }),
  ge("dacia:spring:default", "renault-electric-zoe", "45/65 CV", 2021, { transmission: "automatico", consumption: 13.9 }),
  ge("ford:ka:mk3", "firefly-1-0", "1.2 69", 2009, { endYear: 2016, consumption: 5.0 }),
  ge("ford:c-max:mk2", "ecoboost-1-0", "1.0 EcoBoost / 1.6/2.0 gasolina", 2010, { endYear: 2019, consumption: 5.8 }),
  ge("ford:c-max:mk2", "hdi-1-6", "1.5/1.6/2.0 TDCi", 2010, { endYear: 2019, consumption: 4.4 }),
  ge("ford:ecosport:mk2", "ecoboost-1-0", "1.0 EcoBoost 100/125", 2017, { endYear: 2022, consumption: 5.9 }),
  ge("ford:ecosport:mk2", "hdi-1-6", "1.5 TDCi", 2017, { endYear: 2019, consumption: 4.5 }),
  ge("ford:galaxy:mk3", "ecoboost-1-0", "1.5/2.0 EcoBoost 160/240", 2015, { consumption: 7.6 }),
  ge("ford:galaxy:mk3", "ecoblue-1-5", "2.0 EcoBlue 150/190", 2015, { transmission: "automatico", consumption: 5.4 }),
  ge("hyundai:bayon:default", "kappa-1-0-tgdi", "1.0 T-GDi 100/120", 2021, { consumption: 5.5 }),
  ge("hyundai:bayon:default", "kappa-1-25-mpi", "1.2 MPi 84", 2021, { consumption: 5.7 }),
  ge("kia:carnival:ka4", "hyundai-2-2-crdi", "2.2 CRDi 200", 2014, { transmission: "automatico", endYear: 2021, consumption: 7.3 }),
  ge("opel:meriva:b", "opel-1-4-turbo", "1.4 / 1.4 Turbo 100/140", 2010, { endYear: 2017, consumption: 6.2 }),
  ge("opel:meriva:b", "opel-1-6-cdti", "1.3/1.7 CDTi", 2010, { endYear: 2017, consumption: 4.4 }),
  ge("opel:vectra:c", "opel-1-6-16v", "1.8/2.2 16V", 2002, { endYear: 2008, consumption: 7.8 }),
  ge("opel:vectra:c", "opel-1-6-cdti", "1.9/3.0 CDTi", 2002, { endYear: 2008, consumption: 5.4 }),
  ge("opel:antara:default", "opel-1-6-cdti", "2.0/2.2 CDTi", 2006, { transmission: "automatico", endYear: 2015, drivetrain: "total", consumption: 6.8 }),
  ge("opel:antara:default", "opel-1-4-turbo", "2.4 gasolina", 2006, { endYear: 2015, consumption: 9.2 }),
  ge("citroen:xsara:n1", "psa-1-6-vti", "1.4-2.0 16V", 1997, { endYear: 2005, consumption: 7.2 }),
  ge("citroen:xsara:n1", "hdi-1-6", "1.9/2.0 HDi", 1998, { endYear: 2005, consumption: 4.8 }),
  ge("citroen:saxo:default", "psa-1-6-vti", "1.0-1.6 16V", 1996, { endYear: 2003, consumption: 6.0 }),
  ge("citroen:c2:default", "psa-1-6-vti", "1.1-1.6 16V / VTS", 2003, { endYear: 2009, consumption: 6.2 }),
  ge("citroen:c2:default", "hdi-1-6", "1.4 HDi", 2003, { endYear: 2009, consumption: 4.1 }),
  ge("mazda:5:cw", "skyactiv-g-2-0", "1.8/2.0 MZR", 2010, { endYear: 2018, consumption: 7.4 }),
  ge("mazda:5:cw", "hdi-1-6", "1.6 MZ-CD", 2010, { endYear: 2015, consumption: 4.9 }),
  ge("fiat:sedici:default", "firefly-1-0", "1.6/2.0 gasolina", 2006, { endYear: 2014, drivetrain: "total", consumption: 7.1 }),
  ge("fiat:sedici:default", "fiat-1-6-multijet", "1.9 Multijet", 2006, { endYear: 2014, drivetrain: "total", consumption: 5.5 }),
  ge("volvo:v50:default", "volvo-t3-t4", "1.6-2.4 gasolina", 2004, { endYear: 2012, consumption: 7.6 }),
  ge("volvo:v50:default", "volvo-d3-d4", "1.6/2.0 D", 2004, { endYear: 2012, consumption: 4.8 }),
  ge("volvo:s40:default", "volvo-t3-t4", "1.6-2.4 gasolina", 2004, { endYear: 2012, consumption: 7.5 }),
  ge("volvo:s40:default", "volvo-d3-d4", "1.6/2.0 D", 2004, { endYear: 2012, consumption: 4.7 }),
  ge("volvo:c30:default", "volvo-t3-t4", "T5 230/250", 2006, { endYear: 2013, consumption: 8.4 }),
  ge("volvo:c30:default", "volvo-d3-d4", "1.6/2.0 D", 2006, { endYear: 2013, consumption: 4.6 }),
  ge("alfa-romeo:147:937", "vag-2-0-fsi", "1.6/2.0 Twin Spark", 2000, { endYear: 2010, consumption: 7.6 }),
  ge("alfa-romeo:147:937", "alfa-1-6-jtdm", "1.9 JTD", 2000, { endYear: 2010, consumption: 5.0 }),
  ge("alfa-romeo:156:932", "vag-2-0-fsi", "1.6-2.5 V6", 1997, { endYear: 2005, consumption: 8.2 }),
  ge("alfa-romeo:156:932", "alfa-2-0-jtdm", "1.9/2.4 JTD", 1997, { endYear: 2005, consumption: 5.3 }),
  ge("jeep:grand-cherokee:wk2", "jeep-v6-3-6", "3.6 Pentastar V6", 2011, { transmission: "automatico", drivetrain: "total", consumption: 10.8 }),
  ge("jeep:grand-cherokee:wk2", "jeep-3-0-crd", "3.0 CRD V6", 2011, { transmission: "automatico", drivetrain: "total", consumption: 7.2 }),
  ge("jeep:wrangler:jl", "jeep-v6-3-6", "3.6 Pentastar V6", 2018, { transmission: "automatico", drivetrain: "total", consumption: 11.5 }),
  ge("land-rover:range-rover:l405", "landrover-3-0-sdv6", "3.0 SDV6", 2012, { transmission: "automatico", drivetrain: "total", endYear: 2022, consumption: 8.1 }),
  ge("land-rover:defender:l663", "landrover-2-0-ingenium-d", "D200 / D250", 2020, { transmission: "automatico", drivetrain: "total", consumption: 8.4 }),
  ge("land-rover:defender:l663", "landrover-3-0-sdv6", "D300", 2020, { transmission: "automatico", drivetrain: "total", consumption: 9.1 }),
  ge("land-rover:discovery:l462", "landrover-3-0-sdv6", "D300", 2017, { transmission: "automatico", drivetrain: "total", consumption: 8.6 }),
  ge("land-rover:discovery:l462", "landrover-2-0-ingenium-d", "D200 / D250", 2017, { transmission: "automatico", drivetrain: "total", consumption: 7.6 }),
  ge("lexus:is:xe30", "lexus-2-0-hybrid", "IS 300h", 2013, { transmission: "automatico", drivetrain: "trasera", consumption: 4.9 }),
  ge("lexus:es:xz10", "toyota-2-5-hybrid", "ES 300h", 2018, { transmission: "automatico", consumption: 5.2 }),
  ge("suzuki:sx4:default", "suzuki-1-2-dualjet", "1.6 gasolina", 2006, { endYear: 2014, drivetrain: "total", consumption: 6.9 }),
  ge("suzuki:sx4:default", "fiat-1-6-multijet", "1.9 diésel", 2006, { endYear: 2014, drivetrain: "total", consumption: 5.4 }),
  ge("suzuki:baleno:default", "suzuki-1-4-boosterjet", "1.0 Boosterjet", 2016, { consumption: 5.0 }),
  ge("suzuki:baleno:default", "suzuki-1-2-dualjet", "1.2 Dualjet Hybrid", 2016, { consumption: 4.7 }),
  ge("mitsubishi:colt:z30", "smart-1-0-na", "1.1/1.3/1.5 gasolina", 2004, { endYear: 2012, consumption: 5.6 }),
  ge("mitsubishi:pajero:v80", "mitsubishi-2-5-did", "3.2 DI-D", 2006, { endYear: 2021, transmission: "automatico", drivetrain: "total", consumption: 9.0 }),
  ge("mitsubishi:l200:kb", "mitsubishi-2-5-did", "2.2/2.4 DI-D", 2015, { transmission: "automatico", drivetrain: "total", consumption: 7.6 }),
  ge("tesla:model-s:default", "tesla-electric-awd", "Long Range / Plaid", 2016, { transmission: "automatico", drivetrain: "total", consumption: 17.9 }),
  ge("tesla:model-x:default", "tesla-electric-awd", "Long Range / Plaid", 2016, { transmission: "automatico", drivetrain: "total", consumption: 19.8 }),
  ge("mg:mg5:default", "mg-electric", "Excite / Exclusive", 2022, { transmission: "automatico", consumption: 15.9 }),
  ge("ssangyong:korando:default", "ssangyong-2-2-diesel", "e-XDi220", 2019, { transmission: "automatico", consumption: 6.0 }),
  ge("ssangyong:tivoli:default", "ssangyong-2-2-diesel", "e-XDi160", 2015, { consumption: 5.4 }),
  ge("ssangyong:rexton:default", "ssangyong-2-2-diesel", "e-XDi220", 2017, { transmission: "automatico", drivetrain: "total", consumption: 7.8 }),
  ge("chevrolet:aveo:t300", "opel-1-6-16v", "1.2/1.4/1.6", 2011, { endYear: 2015, consumption: 6.4 }),
  ge("chevrolet:aveo:t300", "fiat-1-6-multijet", "1.3 diésel", 2011, { endYear: 2015, consumption: 4.5 }),
  ge("chevrolet:cruze:j300", "opel-1-6-16v", "1.6/1.8", 2009, { endYear: 2015, consumption: 7.2 }),
  ge("chevrolet:cruze:j300", "opel-1-6-cdti", "1.7/2.0 VCDi", 2009, { endYear: 2015, consumption: 4.9 }),
  ge("chevrolet:captiva:c100", "opel-1-6-cdti", "2.0/2.2 VCDi", 2006, { transmission: "automatico", endYear: 2015, drivetrain: "total", consumption: 7.0 }),
  ge("chevrolet:captiva:c100", "opel-1-4-turbo", "2.4 gasolina", 2006, { endYear: 2015, consumption: 9.4 }),
];
