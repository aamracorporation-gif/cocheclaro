...
export const maintenanceItems: MaintenanceItem[] = [
  ...
  { id: "m-n47-aceite", engineId: "bmw-n47-2-0d", item: "Cambio de aceite y filtro", intervalKm: 15000, intervalMonths: 12, notes: "Acortar el intervalo ayuda a cuidar la cadena de distribución." },
  { id: "m-n47-correa-aux", engineId: "bmw-n47-2-0d", item: "Correas auxiliares y rodillos tensores", intervalKm: 100000 },
  { id: "m-vag20fsi-aceite", engineId: "vag-2-0-fsi", item: "Cambio de aceite y filtro", intervalKm: 15000, intervalMonths: 12, notes: "No superar el intervalo en la versión turbo (2.0 TSI)." },
  { id: "m-vag20fsi-correa", engineId: "vag-2-0-fsi", item: "Correa de distribución", intervalKm: 90000, intervalMonths: 84 },
  { id: "m-psavti-aceite", engineId: "psa-1-6-vti", item: "Cambio de aceite y filtro", intervalKm: 15000, intervalMonths: 12 },
  { id: "m-psavti-correa", engineId: "psa-1-6-vti", item: "Correa/cadena de distribución (según versión)", intervalKm: 100000 },
  { id: "m-opel1616v-aceite", engineId: "opel-1-6-16v", item: "Cambio de aceite y filtro", intervalKm: 15000, intervalMonths: 12 },
  { id: "m-opel1616v-correa", engineId: "opel-1-6-16v", item: "Correa de distribución", intervalKm: 90000, intervalMonths: 84 },
  { id: "m-ford16tivct-aceite", engineId: "ford-1-6-tivct", item: "Cambio de aceite y filtro", intervalKm: 15000, intervalMonths: 12 },
  { id: "m-ford16tivct-correa", engineId: "ford-1-6-tivct", item: "Correa de distribución", intervalKm: 100000, intervalMonths: 84 },
  { id: "m-toyota16vvti-aceite", engineId: "toyota-1-6-vvti", item: "Cambio de aceite y filtro", intervalKm: 15000, intervalMonths: 12 },
  { id: "m-toyota20d4d-aceite", engineId: "toyota-2-0-d4d", item: "Cambio de aceite y filtro", intervalKm: 15000, intervalMonths: 12 },
  { id: "m-toyota20d4d-correa", engineId: "toyota-2-0-d4d", item: "Correa de distribución", intervalKm: 160000, intervalMonths: 120 },
  { id: "m-honda22idtec-aceite", engineId: "honda-2-2-idtec", item: "Cambio de aceite y filtro", intervalKm: 15000, intervalMonths: 12 },
  { id: "m-honda22idtec-correa", engineId: "honda-2-2-idtec", item: "Correa de distribución", intervalKm: 120000, intervalMonths: 84 },
  { id: "m-renault16-aceite", engineId: "renault-1-6-16v", item: "Cambio de aceite y filtro", intervalKm: 15000, intervalMonths: 12 },
